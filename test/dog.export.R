...
file.twoBit_path <- "canFam3.2bit";

db <- CisBP.zipload("Canis_familiaris_2018_12_01_11_26_pm.zip", "canFam3");
...
write.table(tf_info, file="canFam3.tf.info", quote=F, row.names=F, col.names=F, sep="\t");
