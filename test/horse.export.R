...
file.twoBit_path <- "equCab2.2bit";

db <- CisBP.zipload("Equus_caballus_2018_12_01_11:38_pm.zip", "horse");
...
write.table(tf_info, file="equCab2.tf.info", quote=F, row.names=F, col.names=F, sep="\t");
